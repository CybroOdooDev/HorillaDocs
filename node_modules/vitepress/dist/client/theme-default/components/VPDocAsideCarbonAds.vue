      ...
      <span>
        <span class="carbon-wrap">
          <a href="https://demo.horilla.com" class="carbon-img" target="_blank" rel="noopener sponsored">
            <img src="/logo-white-bg.png" border="0"
             height="100" width="130" data-no-statview="no" style="max-width: 130px;">
          </a>
          <Badge type="tip" class="mt" text="Try Demo" />
        </span>
        <a href="https://horilla.com"
          class="carbon-poweredby" target="_blank" rel="noopener sponsored">Free and Open Source Hrms</a>
      </span>
    </div>
  </div>
</template>
